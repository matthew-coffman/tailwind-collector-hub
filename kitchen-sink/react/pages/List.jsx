...
export default function ListPage() {
  ...
  return (
    <Page>
      ...
      <List>
        <ListItem media={<GrassIcon />} title="Ivan Petrov" after="CEO" />
        <ListItem
          title="John Doe"
          media={<GrassIcon />}
          after={<Badge>5</Badge>}
        />
        <ListItem media={<GrassIcon />} title="Jenna Smith" />
      </List>
      <BlockTitle>Links</BlockTitle>
      <List>
        <ListItem media={<GrassIcon />} link title="Ivan Petrov" after="CEO" />
        <ListItem media={<GrassIcon />} link title="John Doe" after="Cleaner" />
        <ListItem media={<GrassIcon />} link title="Jenna Smith" />
      </List>
